            ...
            validate: {
                payload: Joi.object({
                    ...
                    family_details: Joi.object({
                        father_name: Joi.string().trim().required().messages({
                            'any.required': 'Father name is required.',
                        }),
                        mother_name: Joi.string().trim().required().messages({
                    ...
                    education_details: Joi.object({
                        ...
                        college_name: Joi.string().trim().required().messages({
                            'any.required': 'College name is required.',
                        }),
                    }).required(),
                    employment_details: Joi.object({
                        employee_in: Joi.string().trim().required().messages({
